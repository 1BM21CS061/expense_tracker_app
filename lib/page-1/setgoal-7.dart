...
class setgoal7 extends StatefulWidget {
  const setgoal7({Key? key}) : super(key: key);
  @override
  State<setgoal7> createState() => _setgoal7State();
}

class _setgoal7State extends State<setgoal7> {
  @override
